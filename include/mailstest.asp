...
' Estoy comentando todas las líneas que siguen para que no construya el archivo de texto
' Cambié la función de la línea 479 para verificar si ahora sí reciben los mails en Devic (sin attach)
'	  dim file
'	  file = "D:\Inetpub\wwwroot\odtweb\attaches\" & codigoODT & ".txt" '-------------- Verificar si este no es el problema-------------'
'	  dim fs,fname
'      set fs=Server.CreateObject("Scripting.FileSystemObject")
...
'	objCDOMail.Subject = subject
'	objCDOMail.HtmlBody = htmlbody
	'objCDOMail.AddAttachment "D:\Inetpub\wwwroot\odtweb\attaches\prueba.txt" 'file
'	objCDOMail.Send
'	set objCDOMail=nothing
...
'		sendmail USUARIO_DEFAULT,  "gsieder@dow.com", "ODT | Confirmada Orden de Trabajo Nro: " & codigoODT, s
                
        sendmailConAttach USUARIO_DEFAULT, "gsieder@dow.com",  "ODT | Confirmada Orden de Trabajo Nro: " & codigoODT, s, codigoODT
'		sendmailConAttach USUARIO_DEFAULT, "gsieder@dow.com",  "ODT | Confirmada Orden de Trabajo 33897", s, codigoODT    
