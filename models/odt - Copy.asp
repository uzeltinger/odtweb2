...
Class Odt
	...
	if Not (RS.EOF Or RS.BOF) then
      ...
      ' si estas leyendo esto... grrrr grrrr
        ...
        out = out + ",""coeficienteGM"":"""& obtenerCGC(f) &""""
		  ...
		  out = out + ",""materiales"":["& getSublistaJSON("SELECT codigoODT, MaterialesTxt, Cant, Precio, ItemID, Observaciones, fechaCreacion, mnCreacion FROM odtitemsmateriales oim WHERE oim.CodigoODT = "& codigoODT & " ORDER BY fechaCreacion") &"]"
  ...
  Private Function getTotalODT(codigoODT)
    ...
    RS2.Open "SELECT SUM(oim.Cant * oim.Precio) AS totalMateriales FROM odtitemsmateriales oim WHERE oim.codigoodt = "& codigoODT,conexion,0,1,1
